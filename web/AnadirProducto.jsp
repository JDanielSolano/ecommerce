                                ...
                                <form class="form-horizontal" action="Producto" method="post" >
                                    <fieldset>
                                        ...
                                        <div class="control-group">
                                            ...
                                            <div class="controls">
                                                <input class="input-xlarge focused" id="focusedInput" type="text" name="marca">
                                            </div>
                                        </div>
                                        ...
                                        <div class="control-group">
                                            ...
                                            <div class="controls">
                                                <input class="input-xlarge focused" id="focusedInput" type="text" name="descripcion">
                                            </div>
                                        </div>
                                        ...
                                        <div class="control-group">
                                            ...
                                            <div class="controls">
                                                <input class="input-xlarge focused" id="focusedInput" type="text" name="precio">
                                            </div>
                                        </div>
                                        ...
                                        <div class="control-group">
                                            ...
                                            <div class="controls">
                                                <input class="input-xlarge focused" id="focusedInput" type="text" name="imagen">
                                            </div>
                                        </div>
                                        ...
                                        <div class="form-actions">
                                            <button type="submit" class="btn btn-primary" >Añadir</button>
                                                <a href="ListaProductos.jsp"><button type="button" class="btn btn-inverse">Cancelar</button></a>
                                        </div>
                                    </fieldset>
                                </form>
                            </div>
