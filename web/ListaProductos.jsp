...
<%       Operador operador = new Operador();
    ArrayList<Producto> list = operador.getAllProducto();
                    ...
                    <div class="row-fluid sortable">		
                        <div class="box span12">
                            <div class="box-header" data-original-title>
                                <h2><i class="halflings-icon white user"></i><span class="break"></span>Productos</h2>
                                <div class="box-icon">
                            ...
                            <div class="box-content">
                                <table class="table table-striped table-bordered bootstrap-datatable datatable">
                                    <thead>
                                        <tr>
                                            ...
                                            <th class="hidden-phone">Marca</th>
                                    ...
                                    <tbody>
                                        ...
                                        <tr>
                                            <td><%= u.getId()%></td>
                                            <td><IMG SRC="<%= u.getImagen()%>"  WIDTH="50" HEIGHT="50" /></td>
                                            <td><%= u.getMarca()%></td>
                                            <td><%= u.getDescripcion()%></td>
                                            <td>₡<%= u.getPrecio()%></td>

                                            <td> 
                                                <a href="Producto?id=<%= u.getId()%>&action=Eliminar"> <input class="btn btn-danger" type="button" value="Eliminar"> </a> 
                                                <a href="Producto?id=<%= u.getId()%>&action=Editar"> <input class="btn btn-primary" type="button" value="Editar"> </a>
                                            </td>
                                        </tr>
                                        <%}%>
                                    </tbody>
                                ...
                                <br>
                                <a href="AnadirProducto.jsp"> <input class="btn btn-primary" type="button" value="Añadir"> </a>
                            </div>
                        </div>
                    </div>
                </div>
