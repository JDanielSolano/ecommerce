                    ...
                    <div class="row-fluid sortable">		
                        <div class="box span12">
                            <div class="box-header" data-original-title>
                                <h2><i class="halflings-icon white user"></i><span class="break"></span>Editar usuario</h2>
                                <div class="box-icon">
                            ...
                            <div class="box-content">
                                <form class="form-horizontal" action="ConfirmarEditar" method="post">
                                    <fieldset> 

                                        <div class="control-group">
                                            <label class="control-label"   for="focusedInput">ID:</label>
                                            <div class="controls">
                                                <input class="input-xlarge focused" id="focusedInput" type="text" name="id" value="<%= usuario.getId()%>" readonly="">
                                            </div>
                                        </div>
                                        ...
                                        <div class="control-group">
                                            ...
                                            <div class="controls">
                                                <input class="input-xlarge focused" id="focusedInput" type="text" name="usuario" value="<%= usuario.getUsuario()%>" readonly="">
                                            </div>
                                        </div>
                                        ...
                                        <div class="control-group">
                                            ...
                                            <div class="controls">
                                                <input class="input-xlarge focused" id="focusedInput" type="text" name="foto" value="<%= usuario.getFoto()%>">
                                            </div>
                                        </div>
                                        ...
                                        <div class="control-group">
                                            ...
                                            <div class="controls">
                                                <input class="input-xlarge focused" id="focusedInput" type="text" name="nombre" value="<%= usuario.getNombre()%>">
                                            </div>
                                        </div>
                                        ...
                                        <div class="control-group">
                                            ...
                                            <div class="controls">
                                                <input class="input-xlarge focused" id="focusedInput" type="text" name="apellidos" value="<%= usuario.getApellidos()%>">
                                            </div>
                                        </div>
                                        ...
                                        <div class="control-group">
                                            ...
                                            <div class="controls">
                                                <input class="input-xlarge focused" id="focusedInput" type="password" name="contrasena" value="<%= usuario.getContrasena()%>">
                                            </div>
                                        </div>
                                        ...
                                        <div class="control-group">
                                            ...
                                            <div class="controls">
                                                <input class="input-xlarge focused" id="focusedInput" type="text" name="correo" value="<%= usuario.getCorreo()%>" readonly="">
                                            </div>
                                        </div>
