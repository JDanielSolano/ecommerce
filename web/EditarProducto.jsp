                    ...
                    <div class="row-fluid sortable">		
                        <div class="box span12">
                            <div class="box-header" data-original-title>
                                <h2><i class="halflings-icon white user"></i><span class="break"></span>Editar producto</h2>
                                <div class="box-icon">
                            ...
                            <div class="box-content">
                                <form class="form-horizontal" action="ConfirmarEditarProducto" method="post">
                                    <fieldset>
                                        <div class="control-group">
                                            <label class="control-label" for="focusedInput">ID:</label>
                                            <div class="controls">
                                                <input class="input-xlarge focused" id="focusedInput" type="text" name="id" value="<%= p.getId()%>" readonly="">
                                            </div>
                                        </div>
                                        ...
                                        <div class="control-group">
                                            ...
                                            <div class="controls">
                                                <input class="input-xlarge focused" id="focusedInput" type="text" name="marca" value="<%= p.getMarca()%>">
                                            </div>
                                        </div>
                                        ...
                                        <div class="control-group">
                                            ...
                                            <div class="controls">
                                                <input class="input-xlarge focused" id="focusedInput" type="text" name="descripcion" value="<%= p.getDescripcion()%>">
                                            </div>
                                        </div>
                                        ...
                                        <div class="control-group">
                                            ...
                                            <div class="controls">
                                                <input class="input-xlarge focused" id="focusedInput" type="text" name="precio" value="<%= p.getPrecio()%>">
                                            </div>
                                        </div>

                                        <div class="control-group">
                                            <label class="control-label" for="focusedInput">Imagen:</label>
                                            <div class="controls">
                                                <input class="input-xlarge focused" id="focusedInput" type="text" name="imagen" value="<%= p.getImagen()%>">
                                            </div>
                                        </div>

                                        <div class="form-actions">
                                            <button type="submit" class="btn btn-primary">Editar</button>
                                            <a href="ListaProductos.jsp"><button type="submit" class="btn btn-inverse">Cancelar</button></a>
                                        </div>
                                    </fieldset>
                                </form>
                            </div>
